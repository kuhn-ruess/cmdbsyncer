...
- FEAT: The project overview now shows each rule's match type, conditions, and outcomes at a glance, so you can review a project's logic without opening every rule
