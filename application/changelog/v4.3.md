...
- FEAT: New optional "Require FQDN" setting (Data normalisation) — when enabled, hosts whose name is not a fully-qualified domain name are rejected on creation, whether they come from an import, the web UI or the API
