...
## Unreleased
- FEAT: New Checkmk "Data Quality Check" page — upload a CSV of hostnames and check them against a Checkmk account to see which hosts are present, whether their agent works (the Check_MK service state) and which contact groups are allowed to see them
