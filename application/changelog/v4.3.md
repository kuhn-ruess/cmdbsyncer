...
- FEAT: API users can now be limited to specific accounts — assign accounts to a user and every API call (read, create, bulk, delete, inventory, relations) is restricted to hosts of those accounts; leave it empty to keep full access as before
