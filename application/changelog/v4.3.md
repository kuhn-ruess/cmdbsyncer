...
- FIX: An undefined variable inside Checkmk folder options no longer empties the whole folder path — the host keeps its target folder and only the unresolved options are dropped, instead of every affected host being moved to the root folder
